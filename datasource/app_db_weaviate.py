    ...
    def create_collection(self, collection_name: str = "COLLECTION_NAME") -> None:
        ...
        self.client.collections.create(
            ...
            properties=[
                ...
                wc.Property(name="quantity_of_shares", data_type=wc.DataType.NUMBER, index_filterable=False, index_searchable=False),
                wc.Property(name="market_value_lacs_inr", data_type=wc.DataType.NUMBER, index_filterable=False, index_searchable=False),
                wc.Property(name="asset_under_managment_percentage", data_type=wc.DataType.NUMBER, index_filterable=False, index_searchable=False),
            ],
    ...
    def retrieve_objects_for_query(self, collection_name: str, user_query: str, target_vector: str = "company_info") -> QueryReturn:
        ...
        try:
            ...
            response = collection.query.hybrid(
                ...
                return_properties=VECTOR_NAMES,
            )
...
def format_investment_summary(data_dict: dict[str, str]) -> str:
    ...
    try:
        ...
        summary_string = (
            ...
            f"In {month}, {pms_name} holds {aum_percentage}% of its AUM "
            f"quantity of shares {shares_quantity} has value {market_value} lacs INR "
        )
